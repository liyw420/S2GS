workdir=$1
python scripts/extractimages.py dynerf/$workdir
...
mkdir ./data/dynerf/$workdir/sparse_
cp -r ./colmap_tmp/sparse/0/* ./data/dynerf/$workdir/sparse_
...
python scripts/downsample_point.py ./colmap_tmp/dense/fused.ply ./data/dynerf/$workdir/points3D_downsample2.ply

# git clone https://github.com/Fyusion/LLFF.git
# pip install scikit-image
python LLFF/imgs2poses.py ./colmap_tmp/

cp ./colmap_tmp/poses_bounds.npy ./data/dynerf/$workdir/poses_bounds.npy
