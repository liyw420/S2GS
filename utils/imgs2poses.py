...
import numpy as np
import os
from pose_utils2 import gen_poses
...
if __name__=='__main__':
    gen_poses(args.scenedir, args.match_type) 							# 得到poses_bounds.npy文件的图片分辨率是2704*2028
    pose = np.load(os.path.join(args.scenedir, 'poses_bounds.npy'))