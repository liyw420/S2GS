...
class ModelParams(ParamGroup): 
    def __init__(self, parser, config, sentinel=False):
        ...
        self.frz_offset = "none" # ["none","st","all"]
        self.frz_f_dc = "none"  
...
class OptimizationParamsRest(ParamGroup):
    def __init__(self, parser, config):
        ...
        self.offset_ldecs_lr_rest = 1.0e-4
        ...
        self.offset_lr_scaling_rest = 1.0
    ...
    def extract(self, args):
        g = super().extract(args)
        g.latents_lr_scaling_rest = [g.offset_lr_scaling_rest, 
        ...
        g.ldecs_lr_rest = [g.offset_ldecs_lr_rest,
...
class OptimizationParamsInitial(ParamGroup):
    ...
    def extract(self, args):
        g = super().extract(args)
        g.latents_lr_scaling = [g.offset_lr_scaling, 
                                   g.f_dc_lr_scaling, 
                                   g.f_rest_lr_scaling, 
                                   g.sc_lr_scaling, 
                                   g.rot_lr_scaling, 
...
class QuantizeParams(PrefixParamGroup): 
    def __init__(self, parser, config, sentinel=False):
        self.latent_dim = [1,3,1,24,3,4,1]
        self.latent_norm = ['none']*7
        ...
        self.hidden_dim_dec = [1,3,1,24,3,4,1]
        self.activation = ["relu"]*7
        self.final_activation = ["none"]*7
        self.param_names = ["anchor", "offset", "f_dc", "f_rest", "sc", "rot", "op"]
        self.invert_type = ["dec", "dec", "dec", "dec", "dec", "dec", "dec"]
        self.freeze_after = [0.8]*7
        self.freeze_before = [0.3]*7
